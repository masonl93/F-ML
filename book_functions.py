...
TODO:
- Ch.2: bar imbalances
- Ch.4: Answer 4.5 questions, fully understand
- Ch.5: All question
    - Fully understand
    - Start at square 1 whenever stuck
    - ADF -> unit root -> etc
    - When something doesn't make sense, just go back
      to basic principles to fully grasp
...
# Dollar Bars
def compDollarBars(df, col, size):
    dol = 0
    idx = []
    ...
    return df.iloc[idx].drop_duplicates().dropna()
